...
from scania_etls.public_script import check_raw_data_updates
...
dag = DAG(
    dag_id="dev_etl_before_model_dag",
    default_args=DEFAULT_ARGS,
    catchup=False,
    schedule_interval=None, #Todo dia, toda semana?
...
check_raw_data_updates_task = PythonOperator(
    task_id="check_raw_data_updates_task",
    python_callable=check_raw_data_updates,
...
etl_time_series_model_task = PostgresOperator(
    task_id="etl_time_series_model_task",
    postgres_conn_id="sys_tactics_dev_airflow",
    sql="scania_etls/public_sql/etl_time_series_model.sql",
    dag=dag,
)
