...
from scania_etls.public_script import (
    ...
    update_monthly_demand_forecast,
)
...
dag = DAG(
    dag_id="dev_etl_after_model_dag",
...
etl_model_prediction_part_results_task = PythonOperator(
    task_id="etl_model_prediction_part_results_task",
    python_callable=update_model_prediction_part_results,
    op_kwargs={"conn_id": "sys_tactics_dev_airflow"},
    dag=dag,
)

etl_monthly_demand_forecast_task = PythonOperator(
    task_id="etl_monthly_demand_forecast_task",
    python_callable=update_monthly_demand_forecast,
    op_kwargs={"conn_id": "sys_tactics_dev_airflow"},
    dag=dag,
)
...
(
    begin_task
    >> [
        etl_model_prediction_part_results_task,
        etl_monthly_demand_forecast_task,
    ]
